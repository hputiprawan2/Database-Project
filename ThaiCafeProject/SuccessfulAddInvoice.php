...
<body bgcolor="#FBF5EF">
<title> Thai Cafe: Successful Add Invoice </title>

<div id="content">
	<div id="text">
			<?php
				echo "Invoice has been added!";
			?>
	</div>
			<form action="/ThaiCafeProject/SuccessfulAddInvoice.php" method="post">
			
			<input type="submit" name="add" value="Add More Invoice"/>
